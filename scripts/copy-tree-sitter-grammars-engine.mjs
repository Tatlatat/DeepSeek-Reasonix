...
// Copies the tree-sitter .wasm grammars into dist-engine/grammars so the
// self-contained engine bundle (dist-engine/index.js) finds them via the
// import.meta.url relative lookup in src/code-query/parser.ts (it checks
// `<dir of bundle>/grammars/<file>`). Mirrors copy-tree-sitter-grammars.mjs
// which targets dist/grammars for the regular build.
const SOURCES = [
  [
...
const targetDir = resolve("dist-engine/grammars");
